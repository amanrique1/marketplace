...
public class OrdenDeCompraDetalle {
	...
	private List<ProductoOrdenDetalle> productosOrden;
	 ...
	 * @param valorTotal de la orden de compra
	 ...
	 */
	public OrdenDeCompraDetalle(Long id, LocalDateTime fecha, LocalDateTime fechaUltModificacion,Double valorTotal,EstadoPedido estado, List<ProductoOrdenDetalle> productos,Ubicacion ubicacion,List<CambioEstado> cambios) {
		this.id = id;
		this.fecha = fecha;
	 ...
	 * @param estado de la orden de compra
	 */
	public OrdenDeCompraDetalle(Long id, LocalDateTime fecha, LocalDateTime fechaUltModificacion,EstadoPedido estado) {
		this.id = id;
		this.fecha = fecha;
		this.fechaUltimaModificacion = fechaUltModificacion;
		this.estado = estado;
	 ...
	 */
	public List<ProductoOrdenDetalle> getProductosOrden() {
	 ...
	 */
	public void setProductosOrden(List<ProductoOrdenDetalle> productoOrden) {
