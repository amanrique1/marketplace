...
public class OrdenDeCompraProveedor {
	...
	private List<ProductoOrdenProveedor> productosOrden;
	 ...
	 */
	public OrdenDeCompraProveedor(Long id, LocalDateTime fecha, LocalDateTime fechaUltModificacion, Double valorTotal,EstadoPedido estado, List<ProductoOrdenProveedor> productos,Ubicacion ubicacion,List<CambioEstado> cambios) {
		this.id = id;
		this.fecha = fecha;
	 ...
	 * @param estado de la orden de compra
	 */
	public OrdenDeCompraProveedor(Long id, LocalDateTime fecha, LocalDateTime fechaUltModificacion,EstadoPedido estado) {
		this.id = id;
		this.fecha = fecha;
		this.fechaUltimaModificacion = fechaUltModificacion;
		this.estado = estado;
	...
	/**
	 * @return the productosOrden
	 */
	public List<ProductoOrdenProveedor> getProductosOrden() {
		return productosOrden;
	}

	/**
	 * @param productosOrden the productosOrden to set
	 */
	public void setProductosOrden(List<ProductoOrdenProveedor> productosOrden) {
